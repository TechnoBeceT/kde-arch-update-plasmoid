...
public:
	...
	Q_INVOKABLE void upgradeSystem(bool konsoleFlag, bool aur, bool noconfirm, bool yakuake, bool kitty, bool orphan, bool snapRefreshFlag);
...
signals:
	...
	*/
	 ...
	 */
	void upgradeSystemSignal(bool konsoleFlag, bool aur, bool noconfirm, bool yakuake, bool kitty, bool orphan, bool snapRefreshFlag);
};
